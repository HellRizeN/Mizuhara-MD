...
console.log(color(figlet.textSync('Chizuru MD', {
		font: 'Pagga',
...
require("./Muzuhara")(Miku, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
